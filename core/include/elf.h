 ...
 * @version 1.0
 * @date    23.06.2015.
 * @source  http://www.uclinux.org/pub/uClinux/archive/att-7745/01-elf.h
 *
 * @author Ian Lance Taylor <ian@cygnus.com>
 * @copyright GNU LGPL v2+
 */

#ifndef __flos__ELF_H__
#    define __flos__ELF_H__
